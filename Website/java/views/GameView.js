...
let sair_img = document.getElementById("ui-sair")
let sair_txt = document.getElementById("Sair-txt")
...
let value_change = 1;
let vault_Value = 0;
let startingMinutes = sessionStorage.getItem("Time");
...
let Modal_Dificil_FinalResposta = document.getElementById("Modal_Dificil_FinalResposta");
let Desafio_Final=0;


let x = Math.floor(Math.random() * 12) + 2
let Room = Math.floor(Math.random() * 4) + 1
let FinalX = Math.floor(Math.random() * 5) + 5
let FinalY = Math.floor(Math.random() * 5) + 5
...
function Dinheiro_check(Dinheiro){
    if(Dinheiro >= 40000){
        sair_img.style.width="100%"
        sair_txt.innerHTML="SAIR"
        ChangeScene.style="grid-column: 34/40;grid-row: 34/42;"
    }
}
...
function uptdatetimer() {
    ...
    if(time == 0){
        ...
        window.location.href = "BigTimeOutlaws_1.html";
        return
    }
...
ChangeScene.addEventListener("click",function(event){
    event.preventDefault();
    if(vault_Value==0){
        console.log(parseFloat(2*3.14*x).toFixed(2))
        ...
        if (codigo == (parseFloat(2*3.14*x).toFixed(2))){
            ...
            audio_safe.play()
            resetTimer()
            FirstScene.src="../img/1x/P1VSP3B.png"
            Dialgo_txt.innerHTML ="Ufa conseguimos abrir o cofre, lembro-me disso ser mais facil antigamente."
        ...
        FirstScene.src="../img/1X/P1VSP2.png"
        Dialgo_txt.innerHTML =" Como nos velhos tempos ninguem se feriu e a operaçao foi um sucesso, so nao esperava ser tao dificil."
        value_change +=1
        sair_img.style.width="0%"
        sair_txt.innerHTML=""
        //Primeira Sala
        PrimeiroRet.style="grid-column: 37/41;grid-row:36/40;"
        SegundoRet.style="grid-column: 37/41;grid-row:36/40;"
...
goBack.addEventListener("click", function(event){
    ...
    if(value_change == 1){
        ...
        FirstScene.src="../img/1X/P2VSP1.png"
        //Primeira Sala
        PrimeiroRet.style="grid-column: 37/41;grid-row:36/40;"
        SegundoRet.style="grid-column: 37/41;grid-row:36/40;"
        TerceiroRet.style="grid-column: 37/41;grid-row:36/40;"
        ...
        Dialgo_txt.innerHTML ="Achas mesmo que depois de todo esse tempo ainda temos o que e preciso para assaltar um banco?"  
        value_change +=1
    }
    else if(value_change == 2){
        FirstScene.src="../img/1X/P1VSP2.png"
        Dialgo_txt.innerHTML ="Esse vai ser o nosso ultimo assalto, o nosso corpo pode estar velho mas a mente ainda e jovem vamos fazer isso rapidamente como nos velhos tempos."  
        value_change +=1
    }else if(value_change == 3){
        FirstScene.src="../img/1X/P3VSP1.png"
        Dialgo_txt.innerHTML ="Vamos despachar com isso que ja estou atrasado para a minha soneca da tarde."  
        value_change +=1
    }else if(value_change == 4){
        FirstScene.src="../img/1X/P1VSP3.png"
        Dialgo_txt.innerHTML ="Sabia que deviamos deixar-te em casa, a tua mulher sabe que tu estas aqui?"  
        value_change +=1
    }else if(value_change == 5){
        FirstScene.src="../img/1X/P2VSP1.png"
        Dialgo_txt.innerHTML ="Se nao formos agora a cidade inteira vai saber que estamos aqui!"  
        value_change +=1
    ...
    }else if(value_change == 7){
        FirstScene.src="../img/1X/P3VSP1B.png"
        Dialgo_txt.innerHTML ="De acordo com o informante dentro do cofre se encontra 40.000 euros vamos pegar o maximo que conseguirmos e sair daqui."
        value_change +=1
    
    }else if(value_change == 8){
        FirstScene.src="../img/1X/P1VSP3B.png"
        Dialgo_txt.innerHTML ="Se nao tivermos tempo suficiente nao se preocupem com o restante do dinheiro importante e sair de aqui antes que o xerife chegue."
        value_change +=1
  
    }else if(value_change == 9){
        event.preventDefault()
        Dialgo_txt.innerHTML=""
        if(Room == 1){
            ...
            SextaPergunta.addEventListener("click", function(event){
                event.preventDefault()
                click_sound.play()
                if(Room1Facil2==1){
                    if(Facil_Primeiro == 0){
            ...
            SetimaPergunta.addEventListener("click", function(event){
                event.preventDefault()
                click_sound.play()
                if(Room1Facil3==1){
                    if(Facil_Primeiro == 0){
            ...
            OitavaPergunta.addEventListener("click",function(event){
                event.preventDefault()
                click_sound.play()
                if (Room1Medio4==1){
                    if(Medio_Primeira==0){
            ...
            NonaPergunta.addEventListener("click",function(event){
                event.preventDefault()
                click_sound.play()
                if (Room1Medio5==1){
                    if(Medio_Primeira==0){
            ...
            DecimaPergunta.addEventListener("click", function(event){
                event.preventDefault()
                click_sound.play()
                if(Room1Dificil2==1){
                    if(Dificil_Primeiro==0){
            ...
            DecimaPriPregunta.addEventListener("click",function(event){
                event.preventDefault()
                click_sound.play()
                if (Room1Medio6==1){
                    if(Medio_Primeira==0){
            ...
            Safe.addEventListener("click",function(event){
                event.preventDefault()
                console.log((parseFloat(Math.sqrt(FinalX*FinalX + FinalY*FinalY)*6.28).toFixed(2)))
                click_sound.play()
                if(Desafio_Final==0){
                    Modal_Desafio_Final.style.display = "block";
                    document.getElementById("x").innerHTML="x =" + FinalX
                    document.getElementById("y").innerHTML="y =" + FinalY
                    Modal_Dificil_FinalResposta.addEventListener("click", function(event){
                        event.preventDefault()
                        var Resposta = document.getElementById("Modal_Dificil_FinalInput").value
                        if(Resposta == (parseFloat(Math.sqrt(FinalX*FinalX + FinalY*FinalY)*6.28).toFixed(2))){
                            Dinheiro +=20000
                            Dinheiro_txt.innerHTML= Dinheiro
                            Desafio_Final = 1
                            win_sound.play()
                        ...
                        closeModal("Modal_Dificil_Final");
                    })
                }else{
                    Closed_exe.play()
                }
            ...
            QuintaPergunta.style="grid-column: 4/7;grid-row:27/29;"
            SextaPergunta.style="grid-column: 11/14;grid-row:27/29;"
            ...
            DecimaPriPregunta.style="grid-column: 28/38;grid-row:27/29;"
            Safe.style="grid-column: 19/23;grid-row: 25/32;"
            ...
            QuartaPergunta.style="grid-column: 4/7;grid-row:27/29;"
            QuintaPergunta.style="grid-column: 11/14;grid-row:27/29;"
            ...
            SetimaPergunta.style="grid-column: 7/10;grid-row:27/29;"
            OitavaPergunta.style="grid-column: 30/32;grid-row:16/19;"
            NonaPergunta.style="grid-column: 33/35;grid-row:16/19;"
            DecimaPergunta.style="grid-column: 28/37;grid-row:20/26;"
            DecimaPriPregunta.style="grid-column: 17/25;grid-row:37/40;"
            Safe.style="grid-column: 19/23;grid-row: 25/32;"
    ...
    }else if(value_change == 10){
        FirstScene.src="../img/1X/P2VSP1.png"
        Dialgo_txt.innerHTML ="Essa foi por pouco nao sei se tenho costas para voltar para casa."
        value_change +=1
    }else if(value_change == 11){
        FirstScene.src="../img/1X/P3VSP1.png"
        Dialgo_txt.innerHTML ="Vamos la dividir esse dinheiro que ja nao aguento mais olhar para as vossas caras."
        value_change +=1
    }else if(value_change == 12){
        FirstScene.src="../img/1X/P1VSP2.png"
        Dialgo_txt.innerHTML ="Ate breve companheiros!"
        value_change +=1
    }else if(value_change == 13){
        FirstScene.src="../img/GameBackground/Homescreen-03.png"
        Dialgo_txt.innerHTML ="Dinheiro = "+ Dinheiro
        Dialgo_txt.style="grid-column: 1/41;grid-row:25/29;color:#ffffff;"
        value_change +=1
        goBack.style="grid-column:17/25;grid-row:32/39;"
        PrimeiroRet.style="grid-column:17/25;grid-row:32/39;"
        SegundoRet.style="grid-column:17/25;grid-row:32/39;"
        TerceiroRet.style="grid-column:17/25;grid-row:32/39;"
        QuartaRet.style="grid-column:17/25;grid-row:32/39;"
        QuartaRet_2.style="grid-column:17/25;grid-row:32/39;"
        ChangeScene.style="grid-column:17/25;grid-row:32/39;"
        //Segunda Sala
        PrimieraPergunta.style="grid-column:17/25;grid-row:32/39;"
        SegundaPergunta.style="grid-column:17/25;grid-row:32/39;"
        TerceiraPergunta.style="grid-column:17/25;grid-row:32/39;"
        QuartaPergunta.style="grid-column:17/25;grid-row:32/39;"
        QuintaPergunta.style="grid-column:17/25;grid-row:32/39;"
        SextaPergunta.style="grid-column:17/25;grid-row:32/39;"
        SetimaPergunta.style="grid-column:17/25;grid-row:32/39;"
        OitavaPergunta.style="grid-column:17/25;grid-row:32/39;"
        NonaPergunta.style="grid-column:17/25;grid-row:32/39;"
        DecimaPergunta.style="grid-column:17/25;grid-row:32/39;"
        DecimaPriPregunta.style="grid-column:17/25;grid-row:32/39;"
    }else if(value_change ==14){
        let Nome=User.getUserLogged().username
        User.addLeaderBoard(Nome,Dinheiro)
